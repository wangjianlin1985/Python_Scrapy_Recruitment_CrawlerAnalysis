...
CREATE TABLE `permission_dept`  (
  ...
  `parentId_id` int(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 4650 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `permission_userprofile` VALUES (1, 'pbkdf2_sha256$150000$OjTMSXJgkzrE$jEQCjWbIbXwpN4k2z0o8Yvou1UQGuoJALyL/kGDZFd4=', '2021-03-28 21:12:27.915633', 1, '', '', 1, 1, '2021-02-27 06:20:09.188689', 'admin', '3704adf3-380f-4c27-a8da-60420e8cb4ab', 'admin@qq.com', NULL, NULL, '管理员', '2', '1', 2, '1', '2021-02-27 06:20:09.263192', '2021-03-28 21:12:27.887633', 8);
...
-- ----------------------------
-- Records of permission_userprofile_groups
-- ----------------------------
...
-- ----------------------------
-- Records of permission_userprofile_user_permissions
-- ----------------------------
...
CREATE TABLE `system_messagepushuser`  (
  ...
  `update_datetime` datetime(6) NULL DEFAULT NULL,
  `create_datetime` datetime(6) NULL DEFAULT NULL,
  `message_push_id` int(0) NOT NULL,
  `user_id` int(0) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
-- Records of system_messagepushuser
-- ----------------------------
