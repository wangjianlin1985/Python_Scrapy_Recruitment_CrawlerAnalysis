...
from ..permission.views import MenuModelViewSet, DeptModelViewSet, PostModelViewSet, JzzpModelViewSet, RoleModelViewSet, \
...
router.register(r'jzzp', JzzpModelViewSet)
...
urlpatterns = [
    ...
    re_path('jzzp/tjbyxz/', JzzpModelViewSet.as_view({'get': 'tjbyxz', })),

    re_path('jzzp/tjbycity/', JzzpModelViewSet.as_view({'get': 'tjbycity', })),

    re_path('jzzp/tjbytype/', JzzpModelViewSet.as_view({'get': 'tjbytype', })),

    re_path('jzzp/tjbyxl/', JzzpModelViewSet.as_view({'get': 'tjbyxl', })),

    re_path('jzzp/tjbytime/', JzzpModelViewSet.as_view({'get': 'tjbytime', })),
